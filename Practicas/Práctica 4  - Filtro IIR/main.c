...
int main(void)
{
  ...
  while (1)
  {
    ...
    //Funcion transferencia filtro IIR con coeficientes generados en matlab
    y_n = voltaje*0.020083365564211+x_1*(2*0.020083365564211)+x_2*0.020083365564211+

    y_1*1.561018075800718-y_2*0.641351538057563;
